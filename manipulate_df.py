...
from folder_selection_utils import *
...
if not os.path.isfile("temps_real.csv"):
    ...
    newfile2="temps_real.csv"
    with open(newfile2,"w") as f: 
        new_df.to_csv(newfile2)

elif os.path.isfile("temps_real.csv"):

    new_df=pd.read_csv("temps_real.csv")
    new_df=new_df.interpolate()
    new_headers=list(new_df)
    
    newfile3="temps_real_interpolated.csv"
